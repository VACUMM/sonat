# -*- coding: utf-8 -*-
#
# SONAT documentation build configuration file, created by
...
project = u'SONAT'
from sonat import (__author__ as author, __copyright__ as copyright,
    __version__ as version)
#copyright = u'2017, Stephane Raynaud, Jonathan Wilkins, Guillaume Charria'
#author = u'Stephane Raynaud, Jonathan Wilkins, Guillaume Charria'
...
#html_theme_options = {}
#html_theme_options = {
    #"linkcolor": "#2961B0", #"#11567C",
    #'headerlinkcolor': "#84B5FF",
    ##'headerlinkcolor': "white",
#}
#html_theme_options['headerlinkcolor'] = html_theme_options['linkcolor']
...
html_logo = 'images/sonat-web.png'
...
latex_documents = [
  (master_doc, 'SONAT.tex', u'SONAT Documentation',
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'sonat', u'SONAT Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'SONAT', u'SONAT Documentation',
   author, 'SONAT', 'One line description of project.',
   'Miscellaneous'),
]
